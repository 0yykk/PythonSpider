...
#设置合并的文件
allxls=["E:/python爬虫/2-1python合并多个表格/test1.xlsx","E:/python爬虫/2-1python合并多个表格/test2.xlsx","E:/python爬虫/2-1python合并多个表格/test3.xlsx"]
#设置合并到的文件
endxls="E:/python爬虫/2-1python合并多个表格/endxls.xlsx"
